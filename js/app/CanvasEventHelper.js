...
export class CanvasEventHelper {
    parentElement;
    layers = [];
    canvas = [];
    ...
    static LAYER_IMAGE = 1;
    static LAYER_DRAWING = 2;
    static LAYER_TEMP = 3;
    static LAYER_EVENTS = 4;
    ...
    constructor(parentElement) {
        ...
        this.AddLayer(2); // ImageLayer
        this.AddLayer(3); // DrawingLayer
        this.AddLayer(4); // TempLayer
        this.AddLayer(5); // EventHandlingLayer
    ...
    SetEventOnTopCanvas() {
        ...
        this.AddEvents(this.canvas[CanvasEventHelper.LAYER_EVENTS]);
    }
